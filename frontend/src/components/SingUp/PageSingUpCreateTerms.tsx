...
import './PageSingUpCreateTerms.css'

export function PageSingUpCreateTerms() {
    return (
        <div className='form-singup form-singup-create' style={{ color: '#ffffff', backgroundColor: '#121212' }}>
            <div style={{ width: '400px' }}>
                <div>
                    ...
                    <div className='form-singup-progres-main' role='progressbar' style={{ width: '100%' }}>
                        <div className='form-singup-progres-progres' role='progressbar' style={{ width: '66%' }}>
                        </div>
                    </div>
                    ...
                    <div className='form-singup-progres-main-titles'>
                        ...
                        <div className='form-singup-progres-main-titles-steps'>
                            <span className='form-singup-progres-main-titles-steps-count'>Step 3 of 3</span>
                            <span className='form-singup-progres-main-titles-steps-description'>Terms & Conditions</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div style={{ width: '320px', padding: '0 47.5px', marginTop: '35px' }}>
                ...
                <div className='sing-up-terms'>
                    <div>
                        <input className='sing-up-terms-checbox' type='checkbox'></input>
                    </div>
                    <div>
                        <span>I would prefer not to receive marketing messages from Spotify</span>
                    </div>
                </div>
                <div className='sing-up-terms'>
                    <div>
                ...
                <div className='sing-up-terms-condtions-conteiner'>
                    <div className='sing-up-terms-condtions'>
                        <span>
                            By clicking on sign-up, you agree to Spotify's <span className='sing-up-terms-condtions-link'>Terms and Conditions of Use.</span>
                        </span>
                    </div>

                    <div className='sing-up-terms-condtions'>
                        <span>
                        By clicking on sign-up, you agree to the <span className='sing-up-terms-condtions-link'>Spotify Privacy Policy.</span>
                        </span>
                    </div>
                </div>
                <div className='form-conteiner-login-button-submit login-button-submit-forgot form-conteiner-button'>
                    <input className='form-login-button-submit' type="submit" value='Sing up' />
                </div>
            </div>
        </div>
    );
...
export default PageSingUpCreateTerms;