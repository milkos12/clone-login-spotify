    ...
    return (
        <div className='form-singup form-singup-create' style={{ color: '#ffffff', backgroundColor: '#121212' }}>
                ...
                <div>
                    ...
                    <div className='form-singup-progres-main-titles'>
                        ...
                        <div className='form-singup-progres-main-titles-steps'>
                            <span className='form-singup-progres-main-titles-steps-count'>Step 2 of 3</span>
                            <span className='form-singup-progres-main-titles-steps-description'>Tell us about yourself</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div style={{ width: '320px', padding: '0 47.5px', marginTop: '35px' }}>
                <div>
                    <span className='form-login-title-input'>Name</span>
                    <span className='form-login-title-input-description'><br />This name will appear on your profile</span>
                    <div className='form-login-password-input'>
                        <input className='form-login-input form-login-input-password'></input>
                    </div>
                </div>
                <div>
                    <span className='form-login-title-input'>Date of birth</span>
